...
public class SCSender : MonoBehaviour
{
    ...
    private WaitForSeconds yieldInterval = new WaitForSeconds(0.05f);
    ...
    private void Start()
    {
        ...
        StartCoroutine(SenderUpdate());
    }
    private IEnumerator SenderUpdate()
    {
        while (true)
        {
            ...
            if (deviceState != null)
            {
                deviceState._axis0 = Input.GetAxis("axis0");
                deviceState._axis1 = Input.GetAxis("axis1");
                deviceState._axis2 = Input.GetAxis("axis2");
                deviceState._axis3 = Input.GetAxis("axis3");
                ...
                if (deviceInfo != null)
                {
                    deviceInfo.text = string.Format("Device Info:\n\n" +
                         ...
                         "ThumbR X: {8:0.00}\nThumbR Y: {9:0.00}\nBattery: {10:0.00}\nAxis 11: {11:0.00}\n" +
                         "Axis 12: {12:0.00}\nRoll: {13:0.00}\nAxis 14: {14:0.00}\nAxis 15: {15:0.00}",
                         deviceState._axis0, deviceState._axis1, deviceState._axis2, deviceState._axis3,
